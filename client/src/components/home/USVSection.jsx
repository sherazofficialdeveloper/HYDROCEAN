      ...
      <div className="max-w-full mx-auto px-0">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
          ...
          <motion.div
            ...
            className="flex items-center px-8 sm:px-12 lg:px-16 py-12 lg:py-0 bg-slate-50 order-2"
          >
            <div className="max-w-xl">
              ...
              <p className="text-xl sm:text-2xl font-bold text-dark-200/90 mt-6 leading-snug">
                A USV is a robotic vessel designed to operate on the surface of water bodies autonomously or via remote telemetry controls.
              </p>

              <p className="text-base text-slate-600 mt-4 leading-relaxed">
                Utilizing robust wave-propulsion mechanics, wind configurations, or brushless solar batteries, USVs facilitate extremely long deployments to monitor coastlines and chart hydrographic anomalies.
              </p>
              ...
              <div className="grid grid-cols-2 gap-3 mt-6">
                {features.map((feature, index) => (
                  ...
                  >
                    <feature.icon className="h-4 w-4 text-primary-500 shrink-0" />
