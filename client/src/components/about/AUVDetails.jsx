      ...
      <div className="max-w-full mx-auto px-0">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
          ...
          >
            <div className="max-w-xl">
              ...
              <p className="text-xl sm:text-2xl font-bold text-dark-200/90 mt-6 leading-snug">
                Our AUVs are self-piloted robotic submarines designed to navigate extreme depths without tether cables. They map seabeds, inspect pipelines, and gather critical oceanographic data.
              </p>
          ...
          >
            ...
            >
              <span className="text-4xl font-extrabold text-primary-400 block">6000m</span>
